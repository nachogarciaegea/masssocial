...
export const chatOnlyMcpClients = {
  'Grok Bot':
    'Install the MASSSOCIAL CLI with `npm install -g postiz`, then install the MASSSOCIAL skill with `npx skills add gitroomhq/postiz-agent`. Ask me for my MASSSOCIAL API key and set it as the POSTIZ_API_KEY environment variable before using the CLI.',
} as const;
    ...
    switch (client) {
      ...
      case 'NanoClaw':
        return {
          ...
          hint: 'Run this in your terminal, replace <group-id> with the agent group that should get MASSSOCIAL.',
        };
    }
  }
        ...
        <div>
          ...
          <div className="text-[13px] text-customColor18 mt-[2px]">
            {t(
              ...
              'Connect MASSSOCIAL MCP server to your client (Http streaming) to schedule your posts faster.'
            )}
          </div>
        </div>
          ...
          <div className="flex flex-col gap-[6px]">
            ...
            <div className="flex gap-[6px]">
              {(['oauth', 'apikey'] as const).map((m) => (
                ...
                >
                  {m === 'oauth'
                    ? t('sign_in_no_api_key', 'Sign in with MASSSOCIAL (no API key)')
                    : t('api_key', 'API Key')}
                </button>
              ))}
            </div>
        ...
        <div className="flex flex-col gap-[8px]">
          <div className="text-[12px] text-customColor18 font-[500]">
            ...
            {auth === 'oauth' &&
              ...
              ` ${t(
                'oauth_sign_in_hint',
                'Your agent will open a browser window to sign in to MASSSOCIAL.'
              )}`}
          </div>
...
export const localCliSteps = [
  ...
  {
    label: 'Install the MASSSOCIAL skill for your AI agent',
      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder flex items-start justify-between gap-[12px]">
        <div>
          ...
          <div className="text-[13px] text-customColor18 mt-[2px]">
            {t(
              'cli_description',
              'Use the MASSSOCIAL CLI to automate posting from your terminal, or install the skill to let your AI agent schedule posts for you.'
            )}
          </div>
        </div>
        <div className="flex gap-[6px] shrink-0 pt-[2px]">
  ...
  return (
    <div className="flex flex-col gap-[40px]">
      <div className="text-[14px] text-textColor leading-[1.7]">
        ...
        {t(
          'api_auth_note_line2',
          'If you are building a product that schedules posts on behalf of other MASSSOCIAL users,'
        )}
        <br />
        {t(
          'api_auth_note_line3',
          ...
          <div>
            ...
            <div className="text-[13px] text-customColor18 mt-[2px]">
              {t(
                ...
                'Use MASSSOCIAL API to integrate with your tools.'
              )}
            </div>
          </div>
          <div className="flex gap-[6px] shrink-0 pt-[2px]">
