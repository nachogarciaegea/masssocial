      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder">
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'No MCP or CLI settings needed. Paste this into the chat, the agent installs the MASSSOCIAL CLI and asks you for your API key.'
          )}
        </div>
      </div>
        ...
        <div>
          ...
          <div className="text-[13px] text-customColor18 mt-[2px]">
            {t(
              ...
              'Use the MASSSOCIAL API from your own code, n8n or any other automation'
            )}
          </div>
        </div>
        <a
      ...
      <div>
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'The fastest way: add MASSSOCIAL with one click, you will be asked to sign in'
          )}
        </div>
      </div>
      <a
      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder">
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'Give your agent MASSSOCIAL tools to create, schedule and manage posts'
          )}
        </div>
      </div>
      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder">
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'Install the MASSSOCIAL CLI and the skill that teaches your agent how to use it'
          )}
        </div>
      </div>
...
const OnboardingStep3: FC<{ onBack: () => void; onFinish: () => void }> = ({
  ...
  return (
    <div className="flex flex-col gap-[24px] flex-1">
      <div className="flex gap-[4px] flex-col text-center">
        <div className="text-[24px] font-semibold">
          {t('watch_tutorial_title', 'Learn How to Use MASSSOCIAL')}
        </div>
        <div className="text-[14px] text-customColor18">
          {t(
            'watch_tutorial_description',
            'Watch this short video to learn how to get the most out of MASSSOCIAL'
          )}
        </div>
      </div>
